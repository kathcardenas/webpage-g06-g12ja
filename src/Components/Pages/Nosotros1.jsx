    ...
    return (
        <div>
            <div className="flex justify-center pb-4 text-2xl text-sky-500">
                <h1 className="">¿QIENÉS SOMOS?</h1>
                </div>
             <div className="p-8 text-justify">
                <h2 className="flex justify-center text-xl text-blue-400 pb-2">Nuestra Historia</h2>
            ...
            <div className="p-8 text-justify">
                <h2 className=" flex justify-center text-blue-400  pb-2 text-xl">Nuestra Misión</h2>
            ...
            <div>
                <h2 className="flex justify-center pb-2 text-blue-400 text-xl">Nuestro Equipo</h2>
                <p className="pb-2 text-violet-200 flex justify-center">A continuación los miembros clave de nuestro equipo:</p>
                <div className="text-yellow-50 grid grid-cols-2 gap-4 text-lime-950 font-serif text-cyan-800 ">
